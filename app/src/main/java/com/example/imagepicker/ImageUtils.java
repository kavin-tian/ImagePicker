...
public class ImageUtils {
    private static String THUMB_IMG_DIR_PATH;
    ...
    File compressImage(Context context, String srcImgPath) {
        THUMB_IMG_DIR_PATH = context.getApplicationContext().getCacheDir().getAbsolutePath();
